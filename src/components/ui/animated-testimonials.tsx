...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12 bg-neutral-900 rounded-2xl shadow-md">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        {/* Imagem + setas sobrepostas */}
        <div className="relative h-80 w-full">
          ...
          <div className="absolute inset-0 flex items-center justify-between px-2">
            <button
              onClick={handlePrev}
              className="group/button z-50 flex h-8 w-8 items-center justify-center rounded-full bg-white/80 backdrop-blur dark:bg-white/20"
            >
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <motion.p className="mt-8 text-lg text-gray-100 leading-relaxed">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-white/20"
            >
